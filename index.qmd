...
# Differences to RDF encoding

An official encoding of CRM in RDF is published since version 7.1.2, managed at <https://gitlab.isl.ics.forth.gr/cidoc-crm/cidoc_crm_rdf/>. The encoding of CRM in RDF described in this document differes by introduction of SKOS:

- [E55 Type] has been replaced by [Concept] and the latter is made a subclass of [E28 Conceptual Object].
- [E32 Authority Document] has been replaced by [ConceptScheme] and the latter is made a subclass of [E31 Document]
- [P71 lists] has been replaced by [inScheme] and the latter is made a subproperty of [P67 refers to].
